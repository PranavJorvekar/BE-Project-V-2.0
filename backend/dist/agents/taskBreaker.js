...
exports.TasksForEpicSchema = exports.TaskSchema = void 0;
exports.taskBreaker = taskBreaker;
...
exports.TaskSchema = zod_1.z.object({
    ...
    definitionOfDone: zod_1.z.array(zod_1.z.object({ id: zod_1.z.number(), text: zod_1.z.string(), done: zod_1.z.boolean() })),
    orderIndex: zod_1.z.number(),
});
exports.TasksForEpicSchema = zod_1.z.object({
...
// ─── Real LLM ────────────────────────────────────────────────────────────────
async function realTasks(epics, requirements) {
...
`);
        ...
        const parsed = exports.TasksForEpicSchema.parse(result);
        parsed.tasks.forEach((t) => all.push({ ...t, epicCode: epic.code }));
    }
    return all;
}
// ─── Exported Agent ──────────────────────────────────────────────────────────
async function taskBreaker(epics, requirements) {
...
//# sourceMappingURL=taskBreaker.js.map